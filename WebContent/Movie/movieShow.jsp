      ...
      <div class="concustom ">
        ...
        <div class="concustom1">
          <div class="nav-list">
            ...
            <div class="tablepos">
              <!-- Start Table  -->
              <form action="UpdateMovie" method="post" name="useform">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <input readonly = "readonly" name="id" 
                                      value="<%=mov.getiD()%>" >
                                      </input>
                                  ...
                                  <tr>
                                    ...
                                    <%
                                    if(mov.getMovieName()==null){
                                    	
                                    }
                                    %>
                                    
                                    <td>
                                      <input name="movname" id="movname" value="<%=mov.getMovieName() %>">
                                      </input>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input name="director" id="director" value="<%=mov.getDirector() %>">
                                      </input>
                                  ...
                                  <tr>
                                    ...
                                    <td>  
                                      <input name="origins" id="" value="<%=mov.getOrigins() %>">
                                      </input>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input name="actorset" id="actorset" class="form-control" value="<%=mov.getActor_sum() %>">
                                      </input>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    <input class="form-control" name="Dstyle" value="<%=mov.getD_type() %>"
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input name="score" value="<%=mov.getScore() %>">
                                      </input>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input name="date" value="<%=mov.getRelease_date() %>">
                                      </input>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input name="time" value="<%=mov.getTime() %>">
                                      </input>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input name="language" value="<%=mov.getLanguage() %>">
                                      </input>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input name="money" value="<%=mov.getMoney() %>">
                                      </input>
                        ...
                        <tbody>
                          <div class="form-group">
                            ...
                            <%
                            	if(mov!=null){
                            %>
                            <textarea class="form-control" rows="3" name="introduction" value="<%=mov.getIntroduction() %>"></textarea>
                            <%
