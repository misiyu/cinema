<%@page import="com.entity.Discount"%>
      ...
      <div class="concustom ">
        ...
        <div class="concustom1">
              ...
              <!-- Start Table  -->
                ...
                <div class="panel panel-default">
                  <div class="panel-heading fix">
                    ...
                    <div class="col-md-5"><a class="pull-right btn btn-default" href="#">
                    ...
                    <form method="post" action="SearchUserServlet">
                      <table class="table-responsive">
                        <table class="table table-bordered table-hover table-striped">
                          ...
                          <tr>
                            <th width="10%" scope="col" colspan="4">
                              <b>id</b>
                            </th>
                          ...
                          <%
                          	LinkedList<Discount> list=(LinkedList<Discount>)request.getAttribute("list");
                          	if(list!=null){
                          		int i =1;
                          		for(int j=0;j<list.size();j++){
                          		Discount user = (Discount)list.get(j);
                          ...
                          %>
                          <tr>
                          	<td width="10%" scope="col" colspan="4">
                          		<%=user.getId() %>
                          		<a></a>
                            ...
                            <td width="15%" scope="col" colspan="4" >
                              <a class="btn btn-primary btn-sm" href="?userId=<%=user.getId()%>">Delete</a>
                              <a class="btn btn-primary btn-sm" href="?userId=<%=user.getId()%>">Change</a>
                            </td>
                           </tr>
          ...
          <tr>            
                ...
                <div class="">
                <form method="post" action="../Admin/ListAlldisServlet?CurPage=<%=CurPage-1 %>">                       
