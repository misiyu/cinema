      ...
      <div class="concustom ">
        ...
        <div class="concustom1">
          <div class="nav-list">
            <div class="navbar-collapse collapse in" id="order_navbar" >
              <ul class="nav nav-justified nav-pills hovercssa">
                ...
                <li class="">               
                <form method="post" action="../Admin/ListAllplayServlet">                       
                        ...
                        <table class="table table-bordered table-hover table-striped">
                          <thead>
                            ...
                            <th scope="col" colspan="3">
                                ...
                                <input type="" name="signid" value="" class="spinput">
                            </th>
                            <th scope="col" colspan="3">
                            ...
                            <th scope="col" colspan="3">
                                ...
                                <input type="" name="signname" value="" class="spinput">
                            </th>
                            ...
                            <th scope="col" colspan="2">
                               ...
                               <select class="form-control" name="type">
                                  <option value selected>选择你的用户类型</option>
                          ...
                          <tr>
                            ...
                            <th scope="col" colspan="3">
                                ...
                                <input type="" name="dollar" value="" class="spinput">
                            </th>
                            <th scope="col" colspan="3" >
                            ...
                            <th scope="col" colspan="3">
                                ...
                                <input type="" name="grade" value="" class="spinput">
                            </th>
                            ...
                            <th scope="col" colspan="4">
                                ...
                                <input type="submit" name="search" class="btn btn-primary btnsearch">
                            </th>
                          ...
                          <tr>
                            ...
                            <td width="15%" scope="col" colspan="2" >
                              <a class="btn btn-primary btn-sm" href="DelUserServlet?userId=<%=user.getID()%>">Delete</a>
                              <a class="btn btn-primary btn-sm" href="ShowUserServlet?userId=<%=user.getID()%>">Change</a>
                            </td>
                           </tr>
          ...
          <tr>            
                ...
                <div class="">
                <form method="post" action="../Admin/listAlluserServlet?CurPage=<%=CurPage-1 %>">                       
