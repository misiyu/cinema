                      ...
                      <table class="table-responsive">
                        <table class="table table-bordered table-hover table-striped">
                          ...
                          <tr>
                            ...
                            <td width="15%" scope="col" colspan="2" >
                              <a class="btn btn-primary btn-sm" href="DelUserServlet?userId=<%=user.getUserid()%>">Delete</a>
                              <a class="btn btn-primary btn-sm" href="ShowUserServlet?userId=<%=user.getUserid()%>">Change</a>
                            </td>
                           </tr>
