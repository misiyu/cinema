  ...
  function isNumber(str) {
    ...
    return false;
      ...
      function check(){
        ...
        if(isEmpty(document.useform.grade.value)){
          alert("grade不为空！");
          document.useform.grade.focus();
        return false;
        }
       
        if(!isEmpty(document.useform.grade.value)&&!isGrade(document.useform.grade.value)){
          alert("grade不正确！");
          document.useform.grade.focus();
        return false;
        }
        ...
        return false;
          ...
          console.log("Email is:"+document.useform.userEmail.value)
        }
      ...
      <div class="concustom ">
        ...
        <div class="concustom1">
          <div class="nav-list">
            ...
            <div class="tablepos">
              <!-- Start Table  -->
              <form action="AddUserServlet" method="post" name="useform">
                          	...
                          	<td colspan="2" width="100%">
                               ...
                               <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input name="user_pwd" id="user_pwd">
                                      </input>
